...
@section('title', 'Detail Target Pajak')
    ...
    <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-col gap-2 sm:flex-row">
                ...
                <a
                    href="{{ route('target-pajak.edit', $targetPajak) }}"
        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-bold text-slate-800">
                                {{ $targetPajak->jenisPajak->nama ?? '-' }}
                            </h2>

                            @if (!empty($targetPajak->jenisPajak?->kode))

                                <p class="mt-1 text-xs font-medium text-slate-400">
                                    Kode: {{ $targetPajak->jenisPajak->kode }}
                                </p>
            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-xl border border-indigo-100 bg-indigo-50 p-5">
                        ...
                        <p class="mt-2 text-xl font-bold text-indigo-700">
                            Rp {{ number_format((float) $targetPajak->target, 0, ',', '.') }}
                        </p>
                ...
                <div class="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div class="rounded-xl border border-slate-200 p-4">
                        ...
                        <p class="mt-1 text-sm font-semibold text-slate-700">
                            {{ $targetPajak->created_at?->format('d/m/Y H:i') ?? '-' }}
                        </p>
            ...
            <div class="flex flex-col gap-3 border-t border-slate-200 bg-slate-50 px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-8">
                ...
                <form
                    action="{{ route('target-pajak.destroy', $targetPajak) }}"
                    method="POST"
