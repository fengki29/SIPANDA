...
@section('title', 'Edit Wajib Pajak')
...
<div class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Perbarui informasi wajib pajak yang tersimpan di SIPANDA.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="border-b border-slate-100 bg-slate-50/70 px-6 py-5 sm:px-8">
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="hidden rounded-full bg-blue-50 px-3 py-1.5 text-xs font-semibold text-[#1769AA] sm:block">
                    ID #{{ $wajibPajak->id }}
                </div>
            </div>
        </div>

        <form action="{{ route('wajib-pajak.update', $wajibPajak) }}"
              method="POST"
              class="p-6 sm:p-8">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text"
                               id="nama"
                               name="nama"
                               value="{{ old('nama', $wajibPajak->nama) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text"
                               id="no_hp"
                               name="no_hp"
                               value="{{ old('no_hp', $wajibPajak->no_hp) }}"
                               inputmode="tel"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select id="jenis_wp"
                            ...
                            <option value="Perorangan" {{ old('jenis_wp', $wajibPajak->jenis_wp) === 'Perorangan' ? 'selected' : '' }}>
                                Perorangan
                            </option>
                            <option value="Badan" {{ old('jenis_wp', $wajibPajak->jenis_wp) === 'Badan' ? 'selected' : '' }}>
                                Badan
                            </option>
                        </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <textarea id="alamat"
                                  ...
                                  class="w-full resize-none rounded-xl border border-slate-200 bg-slate-50/60 py-3.5 pl-11 pr-4 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-[#1769AA] focus:bg-white focus:ring-4 focus:ring-blue-50">{{ old('alamat', $wajibPajak->alamat) }}</textarea>
                    </div>
    ...
    {{-- INFO --}}
    <div class="rounded-2xl border border-amber-100 bg-amber-50/60 px-5 py-4">
        <div class="flex items-start gap-3">
            <div class="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-100 text-amber-700">
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke-linecap="round"
                          stroke-linejoin="round"
                          d="M12 9v3.75m0 3.75h.01M10.29 3.86L1.82 18a2 2 0 001.71 2.75h16.94A2 2 0 0022.18 18L13.71 3.86a2 2 0 00-3.42 0z"/>
                </svg>
            </div>

            <div>
                <p class="text-sm font-semibold text-amber-900">
                    Periksa kembali perubahan
                </p>
                <p class="mt-1 text-sm leading-6 text-amber-800">
                    Pastikan data yang diperbarui sudah benar sebelum menekan
                    tombol <span class="font-semibold">Simpan Perubahan</span>.
                </p>
            </div>
        </div>
    </div>
