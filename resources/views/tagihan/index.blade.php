            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-3 text-2xl font-bold text-[#1769AA]">
                        {{ number_format($jumlahBelumBayar, 0, ',', '.') }}
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-5">
                ...
                <div class="custom-dropdown relative">
                    ...
                    >
                        ...
                        >
                            @if(request('jenis_pajak_id'))
                                {{ optional($jenisPajaks->firstWhere('id', request('jenis_pajak_id')))->nama ?? 'Semua Jenis' }}
                            @else
                                Semua Jenis
                            @endif
                        </span>
                    ...
                    @forelse($tagihans as $tagihan)
                        ...
                        <tr class="transition duration-150 hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if($tagihan->wajibPajak?->nik)

                                    <p class="mt-1 text-[9px] text-slate-400">
                                        NIK: {{ $tagihan->wajibPajak->nik }}
                                    </p>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <p class="mt-1 text-[9px] text-slate-400">
                                    Pokok: Rp {{ number_format((float) $tagihan->pokok_pajak, 0, ',', '.') }}
                                </p>
