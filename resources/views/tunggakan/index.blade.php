        ...
        <div class="flex items-start justify-between">
            ...
            <div>
                ...
                <p class="mt-2 text-2xl font-bold tracking-tight text-slate-800">
                    {{ number_format($jumlahTunggakan, 0, ',', '.') }}
                </p>
            </div>
        ...
        <div class="flex items-start justify-between">
            ...
            <div>
                ...
                <p class="mt-2 text-2xl font-bold tracking-tight text-amber-600">
                    {{ number_format($jumlahJatuhTempo, 0, ',', '.') }}
                </p>
            </div>
                    ...
                    <div class="relative" data-dropdown>
                        ...
                        >
                            ...
                            <span class="flex min-w-0 items-center gap-3">
                                ...
                                >
                                    @if(request('jenis'))
                                        {{ optional($jenisPajaks->firstWhere('id', request('jenis')))->nama ?? 'Jenis Pajak' }}
                                    @else
                                        Semua Jenis Pajak
                                    @endif
                                </span>
    ...
    <div class="overflow-x-auto">
        ...
        <table class="min-w-full divide-y divide-slate-100">
            ...
            <tbody class="divide-y divide-slate-100 bg-white">
                ...
                @forelse($tunggakans as $tunggakan)
                    ...
                    <tr class="group transition duration-150 hover:bg-blue-50/30">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-slate-500">
                            {{ $tunggakans->firstItem() + $loop->index }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($tunggakan->wajibPajak?->nik)

                                <div class="mt-1 text-xs text-slate-500">
                                    NIK: {{ $tunggakan->wajibPajak->nik }}
                                </div>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-slate-600">
                            ...
                            {{ $tunggakan->tanggal_jatuh_tempo?->format('d/m/Y') ?? '-' }}
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            ...
                            @if($tunggakan->status === 'jatuh_tempo')
                            ...
                            @elseif($tunggakan->status === 'sebagian')
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a
                                    href="{{ route('tagihan.show', $tunggakan) }}"
                                ...
                                <a
                                    href="{{ route('pembayaran.create', ['tagihan_id' => $tunggakan->id]) }}"
