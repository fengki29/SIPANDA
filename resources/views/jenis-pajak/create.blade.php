...
@section('title', 'Tambah Jenis Pajak')
...
<div class="mb-8">
    ...
    <p class="mt-1 text-sm text-gray-500">
        Tambahkan jenis pajak dan tarif yang berlaku.
    </p>
</div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="deskripsi"
                          id="deskripsi"
                          rows="4"
                          placeholder="Masukkan deskripsi jenis pajak..."
                          class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm">{{ old('deskripsi') }}</textarea>
