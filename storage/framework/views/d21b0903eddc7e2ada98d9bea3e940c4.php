...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Sistem Informasi Pajak Daerah — Tahun <?php echo e($tahun); ?>
            ...
            <div class="relative">
                ...
                >
                    ...
                    <?php $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahunItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button
                            type="button"
                            data-year="<?php echo e($tahunItem); ?>"
                            ...
                            <?php echo e((int) $tahunItem === (int) $tahun
                                ? 'bg-[#E8F4FC] text-[#1769AA]'
                                : 'text-slate-600 hover:bg-slate-50 hover:text-[#1769AA]'); ?>"
                        >

                            <span class="text-sm font-semibold">
                                <?php echo e($tahunItem); ?>

                            </span>


                            <?php if((int) $tahunItem === (int) $tahun): ?>
                ...
                >
                    ...
                    <?php $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahunItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option
                            value="<?php echo e($tahunItem); ?>"
                            <?php echo e((int) $tahunItem === (int) $tahun ? 'selected' : ''); ?>
        ...
        <div class="relative grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="p-6 sm:p-8 lg:col-span-2 lg:p-10">
                ...
                <div class="mt-8 flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('tagihan.create')); ?>"
                ...
                <div class="w-full max-w-xs">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex h-12 w-12 items-center justify-center rounded-full border-2 border-white/20 bg-white/10">
                            ...
                            <span class="text-xs font-bold text-white">
                                <?php echo e(number_format($persentaseTarget, 1, ',', '.')); ?>%
                            </span>
                    ...
                    <div class="mt-5 h-2 overflow-hidden rounded-full bg-white/15">
                        ...
                        <div
                            ...
                            style="width: <?php echo e($targetPercent); ?>%"
                        ></div>
                    ...
                    <div class="mt-3 flex justify-between">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-sm font-bold text-white">
                                Rp <?php echo e(number_format($totalPembayaran, 0, ',', '.')); ?>
                        ...
                        <div class="text-right">
                            ...
                            <p class="mt-0.5 text-sm font-bold text-white">
                                Rp <?php echo e(number_format($totalTarget, 0, ',', '.')); ?>
    ...
    <section class="grid grid-cols-2 gap-4 xl:grid-cols-5">
        ...
        <div class="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <p class="mt-4 text-2xl font-bold text-slate-800">
                <?php echo e(number_format($totalWajibPajak, 0, ',', '.')); ?>

            </p>

            <p class="mt-1 text-[10px] text-slate-400">
                <?php echo e(number_format($wajibPajakAktif, 0, ',', '.')); ?> wajib pajak aktif
            </p>
        ...
        <div class="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <p class="mt-1 text-[10px] text-slate-400">
                <?php echo e(number_format($objekPajakAktif, 0, ',', '.')); ?> objek aktif
            </p>
        ...
        <div class="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <p class="mt-1 text-[10px] text-slate-400">
                Tagihan tahun <?php echo e($tahun); ?>
        ...
        <div class="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <p class="mt-4 truncate text-xl font-bold text-slate-800">
                Rp <?php echo e(number_format($totalNilaiTagihan, 0, ',', '.')); ?>
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-[11px] text-slate-400">
                            Aktivitas penerimaan <?php echo e($tahun); ?>.
                        </p>
                ...
                <div class="mt-4 divide-y divide-slate-100">
                    ...
                    <div class="flex items-center justify-between py-3">
                        ...
                        <span class="text-[11px] font-bold text-slate-700">
                            Rp <?php echo e(number_format($pembayaranHariIni, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between py-3">
                        ...
                        <span class="text-[11px] font-bold text-slate-700">
                            Rp <?php echo e(number_format($pembayaranBulanIni, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between py-3">
                        ...
                        <span class="text-[11px] font-bold text-amber-600">
                            <?php echo e(number_format($tagihanBelumBayar, 0, ',', '.')); ?>
    ...
    <section class="grid grid-cols-1 gap-5 xl:grid-cols-3">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <p class="mt-1 text-[11px] text-slate-400">
                    Kondisi tagihan tahun <?php echo e($tahun); ?>.
                </p>
                    ...
                    <div class="rounded-xl border border-slate-100 bg-slate-50/50 p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="h-2 w-2 rounded-full <?php echo e($config['dot']); ?>"></span>
                            ...
                            <span class="text-sm font-bold text-slate-800">
                                <?php echo e(number_format($jumlah, 0, ',', '.')); ?>
                        ...
                        <div class="mt-3 h-1.5 overflow-hidden rounded-full bg-slate-200">
                            ...
                            <div
                                class="h-full rounded-full <?php echo e($config['dot']); ?>"
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $targetRealisasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-[10px] font-medium text-slate-500">
                                    Rp <?php echo e(number_format($item['target'], 0, ',', '.')); ?>

                                </td>


                                <td class="whitespace-nowrap px-6 py-4 text-right text-[10px] font-bold text-emerald-600">
                                    Rp <?php echo e(number_format($item['realisasi'], 0, ',', '.')); ?>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="h-1.5 flex-1 overflow-hidden rounded-full bg-slate-100">
                                            ...
                                            <div
                                                ...
                                                style="width: <?php echo e(min(max((float) $item['persentase'], 0), 100)); ?>%">
                                            </div>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-1 text-[10px] text-slate-400">
                                        Target pajak tahun <?php echo e($tahun); ?> belum tersedia.
                                    </p>
    ...
    <section class="grid grid-cols-1 gap-5 xl:grid-cols-2">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="divide-y divide-slate-100">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentTagihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e(route('tagihan.show', $tagihan)); ?>"
                       class="group flex items-center gap-4 px-6 py-4 transition hover:bg-slate-50">
                        ...
                        <div class="shrink-0 text-right">
                            ...
                            <span class="mt-1 inline-flex items-center gap-1 rounded-full <?php echo e($status['bg']); ?> px-2 py-1 text-[8px] font-bold <?php echo e($status['color']); ?>">

                                <span class="h-1.5 w-1.5 rounded-full <?php echo e($status['dot']); ?>"></span>
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="divide-y divide-slate-100">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentPembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                    <a href="<?php echo e(route('pembayaran.show', $pembayaran)); ?>"
                       class="group flex items-center gap-4 px-6 py-4 transition hover:bg-slate-50">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="mt-0.5 text-[9px] text-slate-400">
                                ...
                                <?php echo e($pembayaran->tanggal_pembayaran
                        ...
                        <div class="shrink-0 text-right">
                            ...
                            <p class="text-[10px] font-bold text-emerald-600">
                                + Rp <?php echo e(number_format((float) $pembayaran->jumlah_bayar, 0, ',', '.')); ?>
    ...
    <section>
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            ...
            <a href="<?php echo e(route('wajib-pajak.create')); ?>"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const values = <?php echo json_encode($chartPembayaran, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/dashboard.blade.php ENDPATH**/ ?>