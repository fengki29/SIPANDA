...
<?php $__env->startSection('title', 'Laporan Pajak'); ?>
...
<div class="mb-7 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div class="flex flex-wrap items-center gap-2">
        ...
        <a
            href="<?php echo e(route('laporan.export.excel', request()->query())); ?>"
        ...
        <a
            href="<?php echo e(route('laporan.export.pdf', request()->query())); ?>"
                ...
                >
                    ...
                    >
                        ...
                        <?php if(request('jenis')): ?>
                            ...
                            <?php echo e($jenisTerpilih ? $jenisTerpilih->kode . ' - ' . $jenisTerpilih->nama : 'Semua Jenis Pajak'); ?>
                ...
                >
                    ...
                    <?php $__currentLoopData = $jenisPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisPajak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button
                            ...
                            data-label="<?php echo e($jenisPajak->kode); ?> - <?php echo e($jenisPajak->nama); ?>"
                            class="flex w-full items-center rounded-lg px-3 py-2.5 text-left text-sm font-medium text-slate-600 transition hover:bg-blue-50 hover:text-[#1769AA]"
                        >
                            <?php echo e($jenisPajak->kode); ?> - <?php echo e($jenisPajak->nama); ?>
    ...
    <div class="group rounded-2xl border border-blue-100 bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-md">
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <span class="text-xs text-slate-400">
                <?php echo e(number_format($jumlahTagihan, 0, ',', '.')); ?> transaksi
            </span>
        ...
        <div class="flex items-start justify-between">
            ...
            <div>
                ...
                <p class="mt-2 text-xl font-bold tracking-tight text-amber-600">
                    <?php echo e(number_format($persentasePencapaian, 1, ',', '.')); ?>%
                </p>
        ...
        <div class="mt-4">
            ...
            <div class="h-2 overflow-hidden rounded-full bg-slate-100">
                ...
                <div
                    ...
                    style="width: <?php echo e(min($persentasePencapaian, 100)); ?>%"
                ></div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-0.5 text-lg font-bold text-slate-800">
                    <?php echo e(number_format($jumlahTagihan, 0, ',', '.')); ?>
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-0.5 text-lg font-bold text-red-600">
                    <?php echo e(number_format($jumlahBelumLunas, 0, ',', '.')); ?>
    ...
    <div class="overflow-x-auto">
        ...
        <table class="min-w-[900px] w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $jenisPajakRingkasan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ringkasan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="transition hover:bg-slate-50/70">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-xs font-bold text-[#1769AA]">
                                    <?php echo e(strtoupper(substr($ringkasan['kode'], 0, 3))); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-slate-800">
                                        <?php echo e($ringkasan['nama']); ?>

                                    </p>

                                    <p class="mt-0.5 text-xs text-slate-400">
                                        <?php echo e($ringkasan['kode']); ?>

                                        ·
                                        <?php echo e(number_format($ringkasan['jumlah_tagihan'], 0, ',', '.')); ?> tagihan
                                    </p>
                        ...
                        <td class="px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-slate-700">
                                Rp <?php echo e(number_format($ringkasan['target'], 0, ',', '.')); ?>
                        ...
                        <td class="px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-emerald-600">
                                Rp <?php echo e(number_format($ringkasan['realisasi'], 0, ',', '.')); ?>
                        ...
                        <td class="px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-slate-700">
                                Rp <?php echo e(number_format($ringkasan['nilai_tagihan'], 0, ',', '.')); ?>
                        ...
                        <td class="px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-amber-600">
                                Rp <?php echo e(number_format($ringkasan['selisih'], 0, ',', '.')); ?>
                            ...
                            <div class="mx-auto w-36">
                                ...
                                <div class="mb-1.5 flex items-center justify-between gap-3">
                                    ...
                                    <span class="text-xs font-semibold text-slate-600">
                                        <?php echo e(number_format($ringkasan['persentase'], 1, ',', '.')); ?>%
                                    </span>
                                ...
                                <div class="h-2 overflow-hidden rounded-full bg-slate-100">
                                    ...
                                    <div
                                        ...
                                        style="width: <?php echo e(min($ringkasan['persentase'], 100)); ?>%"
                                    ></div>
...
<div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    ...
    <div class="flex flex-col gap-3 border-b border-slate-100 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <span class="inline-flex w-fit items-center rounded-lg bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-600">
            ...
            <?php echo e(number_format($tagihans->total(), 0, ',', '.')); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $tagihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="transition hover:bg-slate-50/70">
                        ...
                        <td class="whitespace-nowrap px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-slate-700">
                                Rp <?php echo e(number_format($totalTagihanItem, 0, ',', '.')); ?>
                        ...
                        <td class="whitespace-nowrap px-5 py-4 text-right">
                            ...
                            <span class="text-sm font-semibold text-emerald-600">
                                Rp <?php echo e(number_format($totalDibayarItem, 0, ',', '.')); ?>
                        ...
                        <td class="whitespace-nowrap px-5 py-4 text-right">
                            ...
                            <?php if($sisaItem > 0): ?>
                                ...
                                <span class="text-sm font-bold text-red-600">
                                    Rp <?php echo e(number_format($sisaItem, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/laporan/index.blade.php ENDPATH**/ ?>