...
<?php $__env->startSection('title', 'Jenis Pajak'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a
            href="<?php echo e(route('jenis-pajak.create')); ?>"
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-2xl font-bold text-emerald-600">
                        <?php echo e($jenisPajaks->where('status', true)->count()); ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-2xl font-bold text-red-600">
                        <?php echo e($jenisPajaks->where('status', false)->count()); ?>
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="flex flex-col gap-2 border-b border-slate-100 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="rounded-lg bg-blue-50 px-3 py-2 text-xs font-semibold text-[#1769AA]">
                <?php echo e($jenisPajaks->count()); ?> jenis pajak
            </div>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full min-w-[1000px] text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $jenisPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisPajak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="transition duration-150 hover:bg-blue-50/30">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <span class="inline-flex items-center rounded-lg bg-blue-50 px-3 py-1.5 text-sm font-bold text-[#1769AA]">
                                    <?php echo e(number_format($jenisPajak->tarif, 2, ',', '.')); ?>%
                                </span>
                            ...
                            <td class="max-w-md px-6 py-4">
                                ...
                                <p
                                    ...
                                    title="<?php echo e($jenisPajak->deskripsi ?? '-'); ?>"
                                >
                                    <?php echo e($jenisPajak->deskripsi ?? '-'); ?>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a
                                        href="<?php echo e(route('jenis-pajak.show', $jenisPajak)); ?>"
                                    ...
                                    <a
                                        href="<?php echo e(route('jenis-pajak.edit', $jenisPajak)); ?>"
                                    ...
                                    <form
                                        action="<?php echo e(route('jenis-pajak.destroy', $jenisPajak)); ?>"
                                        method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/jenis-pajak/index.blade.php ENDPATH**/ ?>