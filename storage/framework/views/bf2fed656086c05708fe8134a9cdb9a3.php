...
<?php $__env->startSection('title', 'Target Pajak'); ?>
...
<div class="space-y-7">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <a
            href="<?php echo e(route('target-pajak.create')); ?>"
        ...
        <div class="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm">
            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">
                        <?php echo e($jumlahTercapai); ?> dari <?php echo e($jumlahTarget); ?> target tercapai
                    </p>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div>
                ...
                <p class="text-xs font-bold uppercase tracking-wide text-gray-500">
                    Progress Penerimaan <?php echo e($tahun); ?>
        ...
        <div class="mt-5 h-3 overflow-hidden rounded-full bg-gray-100">
            ...
            <div
                ...
                style="width: <?php echo e(min((float) $persentaseTotal, 100)); ?>%"
            ></div>
    ...
    <div class="overflow-visible rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <form
            method="GET"
            action="<?php echo e(route('target-pajak.index')); ?>"
            ...
            <div class="flex-1">
                ...
                >
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="custom-option w-full rounded-lg px-3 py-2.5 text-left text-sm font-medium transition hover:bg-blue-50 hover:text-blue-700 <?php echo e((string) $tahun === (string) now()->year ? 'bg-blue-50 text-blue-700' : 'text-slate-700'); ?>"
                            data-value="<?php echo e(now()->year); ?>"
                            data-label="<?php echo e(now()->year); ?>"
                        >
                            <?php echo e(now()->year); ?>
                        ...
                        <?php $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahunItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if((string) $tahunItem !== (string) now()->year): ?>

                                <button
                                    type="button"
                                    class="custom-option w-full rounded-lg px-3 py-2.5 text-left text-sm font-medium transition hover:bg-blue-50 hover:text-blue-700 <?php echo e((string) $tahun === (string) $tahunItem ? 'bg-blue-50 text-blue-700' : 'text-slate-700'); ?>"
                                    data-value="<?php echo e($tahunItem); ?>"
                                    data-label="<?php echo e($tahunItem); ?>"
                                >
            ...
            <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Target dan realisasi penerimaan tahun <?php echo e($tahun); ?>.
                    </p>

                </div>

                <span class="text-xs font-medium text-gray-500">
                    <?php echo e($targetPajaks->count()); ?> jenis pajak
                </span>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $targetPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="transition hover:bg-[#F8FBFE]">
                            ...
                            <td class="px-5 py-5">
                                ...
                                <div class="min-w-[170px]">
                                    ...
                                    <p class="text-sm font-bold text-gray-800">
                                        <?php echo e($target->jenisPajak->nama ?? '-'); ?>

                                    </p>

                                    <?php if(!empty($target->jenisPajak?->kode)): ?>

                                        <p class="mt-1 text-[11px] text-gray-400">
                                            Kode <?php echo e($target->jenisPajak->kode); ?>
                            ...
                            <td class="px-5 py-5">
                                ...
                                <div class="min-w-[150px]">
                                    ...
                                    <div class="h-2 overflow-hidden rounded-full bg-gray-100">
                                        ...
                                        <div
                                            class="h-full rounded-full <?php echo e($persentaseAsli >= 100 ? 'bg-emerald-500' : 'bg-[#1769AA]'); ?>"
                            ...
                            <td class="whitespace-nowrap px-5 py-5 text-center">
                                ...
                                <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-bold <?php echo e($statusClass); ?>">

                                    <span class="h-1.5 w-1.5 rounded-full <?php echo e($dotClass); ?>"></span>
                            ...
                            <td class="whitespace-nowrap px-5 py-5">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a
                                        href="<?php echo e(route('target-pajak.show', $target)); ?>"
                                    ...
                                    <a
                                        href="<?php echo e(route('target-pajak.edit', $target)); ?>"
                        ...
                        <tr>
                            ...
                            >
                                ...
                                <p class="mx-auto mt-1 max-w-md text-sm text-gray-500">
                                    Belum ada target pajak yang dibuat untuk tahun <?php echo e($tahun); ?>.
                                </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/target-pajak/index.blade.php ENDPATH**/ ?>