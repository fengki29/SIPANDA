...
<?php $__env->startSection('title', 'Tambah Wajib Pajak'); ?>
...
<div class="space-y-6">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <form action="<?php echo e(route('wajib-pajak.store')); ?>"
              method="POST"
              class="p-6 sm:p-8">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select id="jenis_wp"
                            ...
                            <option value="Perorangan" <?php echo e(old('jenis_wp') === 'Perorangan' ? 'selected' : ''); ?>>
                                Perorangan
                            </option>
                            <option value="Badan" <?php echo e(old('jenis_wp') === 'Badan' ? 'selected' : ''); ?>>
                                Badan
                            </option>
                        </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <textarea id="alamat"
                                  ...
                                  class="w-full resize-none rounded-xl border border-slate-200 bg-slate-50/60 py-3.5 pl-11 pr-4 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-[#1769AA] focus:bg-white focus:ring-4 focus:ring-blue-50"><?php echo e(old('alamat')); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/wajib-pajak/create.blade.php ENDPATH**/ ?>