...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-7">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <form
                action="<?php echo e(route('notifikasi.index')); ?>"
                method="GET"
                    ...
                    <?php else: ?>
                        ...
                        <?php $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahunItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option
                                ...
                                <?php if($tahun == $tahunItem): echo 'selected'; endif; ?>
                            >
            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-extrabold text-slate-900">
                        <?php echo e(number_format($totalNotifikasi)); ?>
            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-extrabold text-red-600">
                        <?php echo e(number_format($jumlahJatuhTempo)); ?>
            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-extrabold text-orange-600">
                        <?php echo e(number_format($jumlahSegeraJatuhTempo)); ?>
            ...
            <div class="flex items-start justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-extrabold text-amber-600">
                        <?php echo e(number_format($jumlahTargetRendah)); ?>
    ...
    <div class="mb-7 overflow-hidden rounded-2xl border border-red-100 bg-white shadow-sm">
        ...
        <div class="border-b border-red-100 bg-red-50/70 px-6 py-5">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-red-600">
                            Terdapat <?php echo e(number_format($jumlahJatuhTempo)); ?>
                ...
                <a
                    href="<?php echo e(route('tunggakan.index', ['tahun' => $tahun])); ?>"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <tr>
                            ...
                            >
                                ...
                                <p class="mt-1 text-xs text-slate-500">
                                    Kondisi tagihan tahun <?php echo e($tahun); ?> aman.
                                </p>
                            </td>
                        </tr>
    ...
    <div class="mb-7 overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-sm">
        ...
        <div class="border-b border-orange-100 bg-orange-50/70 px-6 py-5">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a
                    href="<?php echo e(route('tagihan.index', ['tahun' => $tahun])); ?>"
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-slate-100">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $tagihanSegeraJatuhTempo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-slate-100">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $tunggakanTerbesar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-right text-sm font-bold text-red-600">
                                Rp <?php echo e(number_format($tagihan->sisa_pembayaran, 0, ',', '.')); ?>
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-amber-700">
                        Jenis pajak dengan realisasi di bawah 50% dari target tahun <?php echo e($tahun); ?>.
                    </p>

                </div>

                <a
                    href="<?php echo e(route('target-pajak.index', ['tahun' => $tahun])); ?>"
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-slate-100">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $targetRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="transition hover:bg-amber-50/30">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <?php if($target->jenisPajak?->kode): ?>

                                    <div class="mt-1 text-xs text-slate-500">
                                        <?php echo e($target->jenisPajak->kode); ?>
                            ...
                            <td class="px-6 py-4 text-right text-sm text-slate-700">
                                Rp <?php echo e(number_format($target->target, 0, ',', '.')); ?>

                            </td>

                            <td class="px-6 py-4 text-right text-sm font-semibold text-blue-700">
                                Rp <?php echo e(number_format($target->realisasi, 0, ',', '.')); ?>
                            ...
                            <td class="px-6 py-4 text-right">
                                ...
                                <span class="inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs font-bold text-amber-700">
                                    <?php echo e(number_format($target->persentase_realisasi, 1, ',', '.')); ?>%
                                </span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/notifikasi/index.blade.php ENDPATH**/ ?>