...
<?php $__env->startSection('title', 'Data Wajib Pajak - SIPANDA'); ?>
...
<div class="space-y-6">
    ...
    <div class="overflow-visible rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        <form action="<?php echo e(route('wajib-pajak.index')); ?>"
              method="GET">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="custom-filter-dropdown relative z-[60]"
                        ...
                        <input type="hidden"
                               name="jenis_wp"
                               value="<?php echo e(request('jenis_wp')); ?>">
                        ...
                        <button type="button"
                            ...
                            <span class="flex min-w-0 items-center gap-3">
                                ...
                                <span data-dropdown-label
                                      class="truncate">
                                    <?php echo e(request('jenis_wp') ?: 'Semua Jenis'); ?>
                        ...
                        <div data-dropdown-menu
                            ...
                            <button type="button"
                                    class="custom-option w-full rounded-lg px-3 py-2.5 text-left text-sm font-medium transition hover:bg-blue-50 hover:text-blue-700 <?php echo e(!request('jenis_wp') ? 'bg-blue-50 text-blue-700' : 'text-slate-700'); ?>"
                                    data-value=""
                                    data-label="Semua Jenis">
                                Semua Jenis
                            </button>

                            <?php $__currentLoopData = $jenisWajibPajak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button"
                                        class="custom-option w-full rounded-lg px-3 py-2.5 text-left text-sm font-medium transition hover:bg-blue-50 hover:text-blue-700 <?php echo e(request('jenis_wp') == $jenis ? 'bg-blue-50 text-blue-700' : 'text-slate-700'); ?>"
            ...
            <div class="mt-5 flex flex-col gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
                ...
                <a href="<?php echo e(route('wajib-pajak.index')); ?>"
        ...
        <?php if($wajibPajaks->count() > 0): ?>
            ...
            <div class="flex flex-col gap-2 border-b border-slate-100 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="inline-flex items-center gap-2 self-start rounded-full bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-500">
                    ...
                    <?php echo e($wajibPajaks->total()); ?> data
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <?php $__currentLoopData = $wajibPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $wajibPajak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr class="group transition hover:bg-blue-50/30">

                                
                                <td class="whitespace-nowrap px-6 py-5 text-sm font-medium text-slate-400">
                                    <?php echo e($wajibPajaks->firstItem() + $index); ?>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-xs font-bold text-[#1769AA]">
                                            <?php echo e(strtoupper(substr($wajibPajak->nama, 0, 1))); ?>
                                ...
                                <td class="whitespace-nowrap px-6 py-5">
                                    <?php if($wajibPajak->jenis_wp === 'Badan'): ?>
                                        <span class="inline-flex items-center gap-1.5 rounded-full bg-purple-50 px-3 py-1.5 text-xs font-bold text-purple-700">
                                            ...
                                            <?php echo e($wajibPajak->jenis_wp); ?>
                                ...
                                <td class="whitespace-nowrap px-6 py-5">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <a href="<?php echo e(route('wajib-pajak.show', $wajibPajak)); ?>"
                                           title="Lihat detail"
                                        ...
                                        <a href="<?php echo e(route('wajib-pajak.edit', $wajibPajak)); ?>"
                                           title="Edit data"
                                        ...
                                        <form action="<?php echo e(route('wajib-pajak.destroy', $wajibPajak)); ?>"
                                              method="POST"
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <p class="text-sm text-slate-500">
                        ...
                        <span class="font-semibold text-slate-700">
                            <?php echo e($wajibPajaks->firstItem() ?? 0); ?>

                        </span>
                        sampai
                        <span class="font-semibold text-slate-700">
                            <?php echo e($wajibPajaks->lastItem() ?? 0); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/wajib-pajak/index.blade.php ENDPATH**/ ?>