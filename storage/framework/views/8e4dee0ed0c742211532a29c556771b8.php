        ...
        <div class="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-800">
                        <?php echo e(number_format($totalAdmin)); ?>
        ...
        <div class="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold tracking-tight text-slate-800">
                        <?php echo e(number_format($totalPetugas)); ?>
                ...
                <div class="relative" id="roleDropdown">
                    ...
                    >
                        ...
                        <span class="flex items-center gap-3">
                            ...
                            <span id="roleDropdownLabel">
                                <?php if(request('role') === 'admin'): ?>
                                    Administrator
                                <?php elseif(request('role') === 'petugas'): ?>
                                    Petugas
                                <?php else: ?>
                                    Semua Role
                                <?php endif; ?>
                    ...
                    >
                        ...
                        <button
                            ...
                            class="role-option flex w-full items-center rounded-lg px-3 py-2.5 text-left text-sm transition hover:bg-blue-50 hover:text-[#1769AA] <?php echo e(!request('role') ? 'bg-blue-50 text-[#1769AA]' : 'text-slate-700'); ?>"
                        >
                        ...
                        <button
                            ...
                            class="role-option flex w-full items-center rounded-lg px-3 py-2.5 text-left text-sm transition hover:bg-blue-50 hover:text-[#1769AA] <?php echo e(request('role') === 'admin' ? 'bg-blue-50 text-[#1769AA]' : 'text-slate-700'); ?>"
                        >
                        ...
                        <button
                            ...
                            data-value="petugas"
                            data-label="Petugas"
                            class="role-option flex w-full items-center rounded-lg px-3 py-2.5 text-left text-sm transition hover:bg-blue-50 hover:text-[#1769AA] <?php echo e(request('role') === 'petugas' ? 'bg-blue-50 text-[#1769AA]' : 'text-slate-700'); ?>"
                        >
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <?php if(request('role')): ?>
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-violet-50 px-3 py-1.5 text-xs font-semibold text-violet-700">
                        ...
                        <?php echo e(request('role') === 'admin' ? 'Administrator' : 'Petugas'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/users/index.blade.php ENDPATH**/ ?>