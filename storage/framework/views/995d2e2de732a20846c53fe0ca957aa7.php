...
<?php $__env->startSection('title', 'Edit Target Pajak'); ?>
...
<div class="min-h-screen bg-slate-50">
    ...
    <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
            ...
            <form
                action="<?php echo e(route('target-pajak.update', $targetPajak)); ?>"
                method="POST"
            >
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $jenisPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisPajak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option
                                ...
                                <?php echo e(old('jenis_pajak_id', $targetPajak->jenis_pajak_id) == $jenisPajak->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="number"
                        name="tahun"
                        value="<?php echo e(old('tahun', $targetPajak->tahun)); ?>"
                        min="2000"
                        max="2100"
                        required
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="number"
                            name="target"
                            value="<?php echo e(old('target', $targetPajak->target)); ?>"
                            min="0"
                            step="0.01"
                            required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="w-full rounded-lg border-slate-300 px-3 py-2.5 text-sm shadow-sm transition focus:border-indigo-500 focus:ring-indigo-500"
                    ><?php echo e(old('keterangan', $targetPajak->keterangan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-between">
                    ...
                    <a
                        href="<?php echo e(route('target-pajak.show', $targetPajak)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT 1\sipanda\resources\views/target-pajak/edit.blade.php ENDPATH**/ ?>